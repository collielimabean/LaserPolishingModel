...
namespace LaserPolishingModelSimulator.Common.SurfacePlot3D
{
    public class SurfacePlotVisual3D : ModelVisual3D
    {
        ...
        private Model3DGroup CreateModel()
        {
            ...
            // if it's a flat plane, force some interval //
            XAxisInterval = (XAxisInterval < 0.0001) ? 0.0001 : XAxisInterval;
            YAxisInterval = (YAxisInterval < 0.0001) ? 0.0001 : YAxisInterval;
            ZAxisInterval = (ZAxisInterval < 0.0001) ? 0.0001 : ZAxisInterval;
