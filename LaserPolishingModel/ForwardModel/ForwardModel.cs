...
namespace LaserPolishingModel.ForwardModel
{
    public class ForwardModel
    {
        ...
        readonly double[] PULSE_DURATION = { 0, 50, 100, 200, 300, 400, 500, 750, 1000 };
        readonly double[] MAX_MELT_TIME = { 0, 102, 215, 406, 653, 868, 1096, 1615, 2090 };
        Tuple<double, double> TerryMeltTimePolyFit;


        public enum MeltTimeAssumption
        {
            Nicholas,
            Justin,
            Brodan,
        ...
        public ForwardModel()
        {
            ...
            TerryMeltTimePolyFit = Fit.Line(PULSE_DURATION, MAX_MELT_TIME);
        }

        public void Run(Laser laser, Material material, ref Surface surface, MeltTimeAssumption assumption = MeltTimeAssumption.Default)
        {
